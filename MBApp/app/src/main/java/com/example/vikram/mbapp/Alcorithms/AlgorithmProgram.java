package com.example.vikram.mbapp.Alcorithms;

/**
 * Created by Vikram on 10/14/2016.
 */
...
public class AlgorithmProgram {
    ...
    public static int partition(int[] array,int start,int end){
        ...
        for(int i=start;i<end;i++){
            if(array[i]<=pivot){
                //swapping the array[i] and array[pindex]
                temp=array[i];
        ...
        //swapping the pivot and array[pindex]
        temp1=array[end];
    ...
    public static int[] quicksort1(int[] array,int start,int end){
        ...
        quicksort1(array,start,pindex-1);
        quicksort1(array,pindex+1,end);
